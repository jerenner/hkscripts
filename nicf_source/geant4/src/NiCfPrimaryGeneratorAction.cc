/// \file NiCfPrimaryGeneratorAction.cc
...
NiCfPrimaryGeneratorAction::NiCfPrimaryGeneratorAction()
...
void NiCfPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
